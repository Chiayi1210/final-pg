...
if (appointmentId != null && !appointmentId.isEmpty()) {
    try {
        ...
        out.println("selectedDate: " + selectedDate);
        out.println("selectedTime: " + selectedTime);
        out.println("selectedName: " + selectedName);
        // 發送取消預約通知郵件
        //try {
           ...
           // mail.setSubject("慢箋預約取消通知");
            ...
            //mailContent.append("<tr><td height=\"200px\" align='center' valign='middle'><p>")
                     //   .append(selectedName).append("，您好!<br>");
           // mailContent.append("您的慢箋預約已取消，以下為您取消的預約資料<br>")
            //            .append("慢箋號碼:<b>").append(appointmentId).append("<br>")
            //            .append(selectedDate).append("<br>").append(selectedTime).append("</b>")
